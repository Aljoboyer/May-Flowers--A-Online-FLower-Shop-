...
const FLowersubscription = () => {
    return (
       <Row className='justify-content-center subscriprow p-4'>
            <Row className="p-2">
           ...
           <Row className="p-4 justify-content-center gy-2 gap-4">
            <Col className="text-center subscolam" lg={4} md={6} sm={12}>
